    ...
    while user_input is not int:
        try:
            ...
            if 1 <= user_input <= 12:
                ...
                print(
                    f'Вы ввели число {user_input}! Введите число в диапазоне от 1 до 12.')
        except ValueError:
            print(
                'Вы ввели не число или оно не целое! Введите число в диапазоне от 1 до 12.')
    return user_input
...
def month_from_dict(number):
    month_dictionary = {1: "Январь", 2: "Февраль", 3: "Март", 4: "Апрель", 5: "Май", 6: "Июнь",
                        7: "Июль", 8: "Август", 9: "Сентябрь", 10: "Октябрь", 11: "Ноябрь", 12: "Декабрь"}
    print(
        f"Словарь. Выбран месяц: {number} - это месяц {month_dictionary[number]}")
...
def input_new_raiting(raiting_data):
    ...
    while trigger:
        try:
            user_input = input(
                "Введите новый рейтинг или 's' что бы остановить работу программы: ")
            if user_input == "s":
                trigger = False
            else:
        ...
        try:
            raiting_data.insert(raiting_data.index(
                new_raitnig_value), new_raitnig_value)
        except ValueError:
...
def input_item_data() -> dict:
    ...
    item = {"Название": item_name, "Цена": item_cost,
            "Колличество": item_count, "Единица": item_value}
    return item
...
def create_structure() -> list():
    ...
    while True:
        ...
        if continue_var == 'n':
            ...
            print(
                "Вы ввели не правильные данные. Введите только y или n. Попробуйте еще раз..")
    return data_list
...
def get_analytic(struct) -> dict:
    ...
    analytic = {"Название": items_names, "Цена": items_costs,
                "Колличество": items_counts, "Единица": items_values}
    return analytic
